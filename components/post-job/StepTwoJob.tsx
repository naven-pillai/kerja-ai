      ...
      <div className="p-6 space-y-5">
          ...
          <div className="mt-3">
            <div className="flex items-center justify-between mb-1.5">
              ...
              {currencyLocked ? (
                ...
                <span className="text-xs text-gray-400">Auto-set from location</span>
              )}
            </div>
            <select
        ...
        <div>
          ...
          <input
            ...
            className="w-full px-4 py-2.5 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#1D4ED8]/30 focus:border-[#1D4ED8] transition-colors"
          />
          <p className="text-xs text-gray-400 mt-1">Help candidates find this job. Press Enter or comma to add a tag.</p>
        </div>
      </div>
